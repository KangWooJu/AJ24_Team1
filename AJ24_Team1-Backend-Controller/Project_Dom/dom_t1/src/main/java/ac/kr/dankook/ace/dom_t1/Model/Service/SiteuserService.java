...
public class SiteuserService {
    ...
    public SiteuserEntity create(String nickname, String email, String psw, String hint, String id) { //  SiteuserRepository를 이용하여 회원 데이터를 생성하는 메서드
        SiteuserEntity user = new SiteuserEntity(); 
        user.setId(id); // Entity에 id 넣기
