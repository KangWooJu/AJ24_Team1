...
public class AuctionRegisterEntity {
    ...
    private Integer category_num = Integer.parseInt(category); // ( 6 . 3 추가 )

    private String locationCode; // 거래 지역 코드 ( 5.24 수정 )

    private String user_year; //  

    private String user_month; // 경매 마감 월 ( 5.27 수정 )

    private String user_day; // 경매 마감 일 ( 5.27 수정 )

    private LocalDateTime createDate; // 작성일자
    /*private LocalDateTime modifyDate; // 수정날짜  ( 5.27 ) 수정*/ 
