...
public class SiteuserController {
    ...
    @PostMapping("/signup")
    public String signup(@Valid @Requestbody SiteuserCreateForm siteuserCreateForm, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
        return "signup_form"; // 회원가입 폼 필요 -> HTML 파일 생성 필요
    }
    ...
    try { // 이미 사용자의 Id 또는 
        siteuserService.create(siteuserCreateForm.getId(), 
